...
<div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-3">
              <img src={icon} className="h-9 w-9 object-contain" alt="Doorspital logo" />
...
<p className="text-xs text-slate-400">
  <span className="text-base font-bold">©</span> 2024 Doorspital. All rights reserved.
</p>
          ...
          <div className="space-y-3 md:col-span-1">
            <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Stay Updated</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300">
